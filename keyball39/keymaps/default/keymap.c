...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEFAULT] = LAYOUT_universal(
        KC_SLSH    , KC_W    , KC_E    , KC_R        , KC_T    ,                       KC_Y   , KC_U     , KC_I    , KC_O    , KC_SCLN ,
        KC_A       , KC_S    , KC_D    , LT(UT, KC_F), KC_G    ,                       KC_H   , KC_J     , KC_K    , KC_L    , KC_P ,
        KC_Z       , KC_X    , KC_C    , KC_V        , KC_B    ,                       KC_N   , KC_M     , KC_COMM , KC_DOT  , KC_Q ,
        KC_LGUI    , KC_SPC  , KC_BSPC , KC_LALT     , MC_ESC  , MC_LSFT,     MC_RSFT, MC_ESC ,  _______ , _______ , _______ , KC_MUTE
    ),
    ...
    [_NAGINATA] = LAYOUT_universal(
        ...
        _______  , _______  , _______  , _______ , NG_MOFF   , NG_SHFT  ,      NG_SHFT  , NG_MOFF , _______  , _______  , _______ , _______
    ),
    ...
    [_NUM] = LAYOUT_universal(
        ...
        KC_1    , KC_2     , KC_3      , KC_4     , KC_5     ,                            KC_6     , KC_7     , KC_8     , KC_9     , TD(TD_0) ,
        KC_PLUS , KC_MINS  , KC_ASTR   , KC_SLSH  , KC_EQL   ,                            KC_BSPC  , C(KC_B)  , C(KC_F)  , KC_SPC   , KC_TILD  ,
    ...
    [_MOUSE] = LAYOUT_universal(
        ...
        SCRL_HO  , _______  , _______  , MC_DRAG  , KC_DBLB  ,                            AC_KEP   ,KC_OG_BTN1,KC_OG_BTN2, _______  , SCRL_HO  ,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    // key_overrideのデバックを行う
    // set_key_overrides("debug");
